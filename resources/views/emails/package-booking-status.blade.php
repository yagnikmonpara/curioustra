    ...
    <div style="max-width: 640px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 2rem 2rem 1rem;">
            ...
            <div style="text-align: center; margin: 2rem 0; padding: 1.5rem; background-color: #f8fafc; border-radius: 8px;">
                ...
                <a href="{{ route('welcome') }}" style="color: #0ea5e9; text-decoration: none; font-weight: 500; transition: all 0.2s ease;">
        ...
        <div style="max-width: 400px; margin: 0 auto;">
                <div style="font-size: 0.875rem; line-height: 1.6;">
                    ...
                    <p style="margin: 0.5rem 0; color: #94a3b8;">
                        ...
                        <a href="mailto:info@curioustra.com" style="color: #7dd3fc; text-decoration: none;">info.curioustra@gmail.com</a>
                    </p>
                </div>
