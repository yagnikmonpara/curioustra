...
const AdminPackageBookings = ({ bookings: initialBookings }) => {
    ...
    const openDetailModal = (booking) => {
        setSelectedBooking({
            ...booking,
            additional_info: booking.additional_info ? JSON.parse(booking.additional_info) : {}
        });
                                ...
                                <table className="min-w-full divide-y divide-sky-200">
                                    <thead className="bg-sky-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-semibold text-sky-700 uppercase">Package</th>
                                            <th className="px-6 py-3 text-left text-xs font-semibold text-sky-700 uppercase">Date</th>
                                            <th className="px-6 py-3 text-left text-xs font-semibold text-sky-700 uppercase">People</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-sky-100">
                                        {filteredBookings.map(booking => (
                                            <tr key={booking.id} className="hover:bg-sky-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-sm text-sky-900">{booking.package.title}</td>
                                                <td className="px-6 py-4 text-sm text-sky-800">
                                                    {new Date(booking.booking_date).toLocaleDateString()}
                                                </td>
                                                <td className="px-6 py-4 text-sm text-sky-800">{booking.number_of_people}</td>
                                                <td className="px-6 py-4 text-sm text-sky-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-sky-50 p-3 rounded-lg">
                                            ...
                                            <p className="text-sky-600">${selectedBooking.package.price}</p>
                                        </div>
                                    </div>
                                    ...
                                    {Object.keys(selectedBooking.additional_info).length > 0 && (
