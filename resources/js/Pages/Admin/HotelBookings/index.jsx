                                ...
                                <table className="min-w-full divide-y divide-sky-200">
                                    <thead className="bg-sky-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-semibold text-sky-700 uppercase">Dates</th>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-sky-50 p-3 rounded-lg">
                                            ...
                                            <p className="text-sky-600">{selectedBooking.hotel.city}, {selectedBooking.hotel.country}</p>
                                        </div>
                                    </div>
